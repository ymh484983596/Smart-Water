<template xmlns="http://www.w3.org/1999/html">
  <div>
    <div v-if="$route.query.objName == '站点2'" style="background: #062047;overflow-x: hidden;">
      <div class="d">
        <div class="boxleft">
          <div class="title1">
        ...
        <div class="divConterRight">
          <div class="icontItem">
            ...
            <div>
              ...
              <div style="float: right;width: 50%;">
                ...
                <div>
                  <p>最大值：{{ DOlist | dataMax }}</p>
                </div>
                <div>
                  <p>最小值：{{ DOlist | dataMin }}</p>
                </div>
                <div>
                  <p>平均值：{{ DOlist | dataMean }}</p>
                </div>
              </div>
            </div>
          </div>
          <div class="icontItem">
            ...
            <div>
              ...
              <div style="float: right;width: 50%;">
                <div>
                  <p>最大值：{{ conductancelist | dataMax }}</p>
                </div>
                <div>
                  <p>最小值：{{ conductancelist | dataMin }}</p>
                </div>
                <div>
                  <p>平均值：{{ conductancelist | dataMean }}</p>
                </div>
              </div>
            </div>
          </div>
          <div class="icontItem">
            ...
            <div>
              ...
              <div style="float: right;width: 50%;">
                <div>
                  <p>最大值：{{ turbiditylist | dataMax }}</p>
                </div>
                <div>
                  <p>最小值：{{ turbiditylist | dataMin }}</p>
                </div>
                <div>
                  <p>平均值：{{ turbiditylist | dataMean }}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bottomLeft">
          ...
          <div class="timedq">
            当前时间： <el-date-picker v-model="planWorkFormQuery.planDate" style="width: 20%;"
              :picker-options="planWorkFormQuery.shortcuts" type="daterange" range-separator="-"
              value-format="yyyy-MM-dd" start-placeholder="开始日期" end-placeholder="结束日期" size="mini"
    ...
    <TP v-if="$route.query.objName == '站点3'"></TP>
    <TN v-if="$route.query.objName == '站点4'"></TN>
  </div>
</template>
